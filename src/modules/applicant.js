        ...
        .then((answer) => {
          if (JSON.stringify(answer.applicantchoice).search("Accept") != -1) {
            ...
            applicants
              ...
              .then((res) => {
                applicants
                  .updateActivity(username, "OfferAccepted")
                  .then((res) => {
                    console.log("Offer Accepted!");
                    logger.processLogs(
                      username,
                      tenant,
                      `Candidate ${username} Accepted offer`
                    );
                  });
              })
            ...
            applicants
              ...
              .then((res) => {
                applicants
                  .updateActivity(username, "OfferRejected")
                  .then((res) => {
                    console.log("Offer rejected");
                    logger.processLogs(
                      username,
                      tenant,
                      `Candidate ${username} Rejected offer`
                    );
                  });
              })
        ...
        .then((answer) => {
          if (JSON.stringify(answer.applicantchoice).search("Accept") != -1) {
            ...
            applicants
              ...
              .then((res) => {
                applicants
                  .updateActivity(username, "InterviewAccepted")
                  .then((res) => {
                    console.log("Interview Accepted!");
                    logger.processLogs(
                      username,
                      tenant,
                      `Candidate ${username} Accepted Interview`
                    );
                  });
              })
            ...
            applicants
              ...
              .then((res) => {
                applicants
                  .updateActivity(username, "InterviewRejected")
                  .then((res) => {
                    console.log("Interview rejected");
                    logger.processLogs(
                      username,
                      tenant,
                      `Candidate ${username} Rejected Interview`
                    );
                  });
              })
