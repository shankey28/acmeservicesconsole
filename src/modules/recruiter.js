            ...
            .then((answer) => {
              ...
              inquirer
                ...
                .then((answer) => {
                  ...
                  applicants
                    .addComment(
                      candidate[0][applicantUserName],
                      answer.comment,
                      token
                    )
                    .then((res) => {
                      if (res) console.log("Comment added successfully");
                      logger.processLogs(
                        username,
                        tenant,
                        `Candidate ${applicantUserName} added comment`
                      );
              ...
              applicants
                ...
                .then((res) => {
                  ...
                  logger.processLogs(
                    username,
                    tenant,
                    `Candidate ${applicantUserName} resume submitted to employer`
                  );
                  recruiterWorkFlow({ token, username, tenant });
                })
